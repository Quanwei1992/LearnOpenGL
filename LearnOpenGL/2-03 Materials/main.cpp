...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "material.ambient"), 0.1745f, 0.01175f, 0.01175f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.61424f, 0.04136f, 0.04136f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "material.specular"), 0.727811f, 0.626959f, 0.626959f); // Specular doesn't have full effect on this object's material
